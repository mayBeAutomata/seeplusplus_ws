/*
class ClassName  // always capitalise the first letter of the class name
{
      member1;  // private members are listed first
      member2;
      ...

public:
     return variable accessFunction1(function parameters);  // Use 'getVariableName' for accessing private variables Use 'setVariableName' for assigning values to private variables
     return variable accessFunction2(function parameters); 
      ...
} ;

returnVariable ClassName:: accessFunction1(function parameters) // You will need to signify that the functions are part of the class definition by using the namespace classname::. 
{
    function statements;
}
